...
NUM_HEADING_BIN = 12
NUM_SIZE_CLUSTER = 10 # one cluster for each type
NUM_OBJECT_POINT = 512
g_type2class={'Car':0, 'Walker':1, 'Bicycle':2, 'TrafficLight':3,
              'TrafficSigns':4, 'Truck':5, 'Van':6, 'Bus':7, 'Motorcycle':8, 'Vehicle':9}
g_class2type = {g_type2class[t]:t for t in g_type2class}
g_type2onehotclass = {'Car':0, 'Walker':1, 'Bicycle':2, 'TrafficLight':3,
              'TrafficSigns':4, 'Truck':5, 'Van':6, 'Bus':7, 'Motorcycle':8, 'Vehicle':9}
...
def placeholder_inputs(batch_size, num_point):
    ...
    one_hot_vec_pl = tf.placeholder(tf.float32, shape=(batch_size, 10))
